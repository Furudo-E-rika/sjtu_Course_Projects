...
class Seq2SeqTagging(nn.Module):
    ...
    def __init__(self, config):
        ...
        #self.rnn_list = []
        #for i in range(50):
        #    self.rnn_list.append(getattr(nn, self.cell)(config.embed_size, config.embed_size, num_layers=4, batch_first=True))
        #    self.rnn_list[i].to("cuda:0")
    ...
    def forward(self, batch):
        ...
        tag_output = self.output_layer(rnn_out, tag_mask, tag_ids)
