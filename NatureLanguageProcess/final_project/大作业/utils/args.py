...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--pretrained', default='bert-base-chinese', type=str, help='type of bert pretrained model')
    ...
    arg_parser.add_argument('--num_heads', default=4, type=int, help='number of attention heads')
    return arg_parser