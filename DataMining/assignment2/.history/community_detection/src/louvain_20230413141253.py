...
def restructuring(G, partition):
    ...
    for node1, node2 in G.edges:
        ...
        if contracted_G.has_edge(comm1, comm2):
            contracted_G[comm1][comm2]['weight'] = contracted_G[comm1][comm2].get('weight', 1) + contracted_G[node1][node2].get('weight', 1)
        else:
            print(comm1, comm2,contracted_G[node1][node2].get('weight', 1))
            contracted_G.add_edge(comm1, comm2, weight=contracted_G[node1][node2].get('weight', 1))
