    ...
    def train(self, config_file, **kwargs):
        ...
        trainloader = torch.utils.data.DataLoader(
            dataset.TrainDataset(
                ...
                train_df,
                label_to_idx,
                augmentation=config["data"]["augmentation_list"],
                augment_type=config["data"]["augment_type"],
                augment_ratio=config["data"]["augment_ratio"],
                audio_mix_ratio=config["data"]["audio_mix_ratio"],
            ),
        ...
        model = getattr(models, config['model']["type"])(
            ...
            channel_list=config['model']['channel_list'],
            kernel_list=config['model']['kernel_list'],
        )
